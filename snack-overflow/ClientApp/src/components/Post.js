            ...
            <div>
                ...
                <div className="container">
                    <div className="main">
                        ...
                        <h2 className="cursor-point" id="2" onClick={(e) => this.showMess(e)}>Paper Review: What do Sketches say about Thinking</h2>
                        <div className='other-tags'><a className='topic-tag' href='javascript:void(0)'>Xem</a><a className='topic-tag' href='javascript:void(0)'>Sửa</a><a className='topic-tag' href='javascript:void(0)'>Xóa</a></div>
                        <h2 className="cursor-point">Test đề mục con con của bài viết</h2>
